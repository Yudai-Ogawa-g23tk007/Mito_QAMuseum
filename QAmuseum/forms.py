...
class parameterEnform(forms.Form):
    ...
    speed = forms.ChoiceField(label="Speed",choices=choice_speed)
    choice_browse=(
        (2.0,"Very Fast"),
        (1.5,"Fast"),
        (1.0,"Normal"),
    ...
    browse = forms.ChoiceField(label="Viewing Speed",choices=choice_browse)
    choice_demand = (
        ('0',"None"),
        ('1',"Medal"),
    ...
    demand = forms.ChoiceField(widget=forms.Select(attrs={'label_type': 'f'}),label="Viewing Place",choices=choice_demand)
